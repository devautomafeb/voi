    ...
    >
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          <Text style={styles.modalText}>Nova Ideia</Text>
          <Text style={styles.label}>Nome do futuro projeto:</Text>
          <TextInput
          ...
          <TouchableOpacity style={[styles.button, { marginTop: 20 }]} onPress={handleAddIdea}>
